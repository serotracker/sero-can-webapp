    ...
    if (properties.seroprevalence) {
      return (
        <div className="col-12 p-0 flex">
          ...
          <div className="col-12 p-0 popup-content">95% CI: {(properties?.seroprevalence - properties?.error).toFixed(2)}%-{(properties?.seroprevalence + properties?.error).toFixed(2)}%</div>

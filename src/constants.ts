...
export const all_columns = ["source_id", "state", "city", "country", "age", "serum_pos_prevalence", "denominator_value", "population_group", 
...
export const pins_modal_columns = ["source_id", "state", "city", "country", "age", "serum_pos_prevalence", "denominator_value", "population_group", 
"overall_risk_of_bias", "source_name", "estimate_grade", "pin_latitude", "pin_longitude", "pin_region_type", 
"sampling_start_date", "sampling_end_date", "url"];

export const pins_columns = ["source_id", "pin_latitude", "pin_longitude", "estimate_grade"];

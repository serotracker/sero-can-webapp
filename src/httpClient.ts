...
export default class httpClient {
    ...
    async getAirtableRecords(filters: Filters,
        ...
        "overall_risk_of_bias", "source_name", "estimate_grade", "pin_latitude", "pin_longitude", "url", "pin_region_type", "first_author", "source_type", "study_type", "test_type", "specimen_type",
        "isotypes_reported", "approving_regulator", "population_group", "sampling_start_date", "sampling_end_date", "lead_organization"];

        const explore_columns = all_columns.slice(0, 14);
